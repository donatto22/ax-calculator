...
var Percentage = {
  ...
  **/
  whatPercentageIs: function whatPercentageIs(number, total) {
  ...
  **/
  percentageOf: function percentageOf(percentage, total) {
  ...
  **/
  percentFromPercent: function percentFromPercent(percentage1, value1, percentage2) {
  ...
  **/
  totalFromPercent: function totalFromPercent(percentage, value) {
